...
const manifestos = [
  ...
  {
    nome: 'texto', versao: '1.1.0', api_widget: 1, modulo: './texto.js', elemento: 'plat-texto',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'botao', versao: '1.1.0', api_widget: 1, modulo: './botao.js', elemento: 'plat-botao',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'imagem', versao: '1.0.0', api_widget: 1, modulo: './imagem.js', elemento: 'plat-imagem',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'cartao', versao: '1.0.0', api_widget: 1, modulo: './cartao.js', elemento: 'plat-cartao',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'incorporar', versao: '1.0.0', api_widget: 1, modulo: './incorporar.js', elemento: 'plat-incorporar',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'divisor', versao: '1.0.0', api_widget: 1, modulo: './divisor.js', elemento: 'plat-divisor',
  ...
  {
    nome: 'menu', versao: '1.0.0', api_widget: 1, modulo: './menu.js', elemento: 'plat-menu',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'controlador', versao: '1.0.0', api_widget: 1, modulo: './controlador.js', elemento: 'plat-controlador',
    esquema_config: objetoFechado({
  ...
  {
    nome: 'compartilhar', versao: '1.0.0', api_widget: 1, modulo: './compartilhar.js', elemento: 'plat-compartilhar',
  ...
  {
    nome: 'login', versao: '1.0.0', api_widget: 1, modulo: './login.js', elemento: 'plat-login',
    esquema_config: objetoFechado({ rotulo: textoCurto }),
    eventos: ['login.mudou'], acoes: ['login.atualizar'], fontes: { min: 0, max: 0, tipos: [] }, i18n: 'widget.login',
  },
  {
    nome: 'idioma', versao: '1.0.0', api_widget: 1, modulo: './idioma.js', elemento: 'plat-idioma',
  ...
  {
    nome: 'tema', versao: '1.0.0', api_widget: 1, modulo: './tema.js', elemento: 'plat-tema',
    esquema_config: objetoFechado({ rotulo: textoCurto }),
