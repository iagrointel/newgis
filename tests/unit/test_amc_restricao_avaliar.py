"""Portao de L3-04 pelo lado de avaliar(): a restricao medida CONTRA O BANCO.

Escrito pela frota remota (agente no Hetzner) em 17/09/2026 e preservado a parte de
test_amc_restricao_combinador.py, que mede compor() como unidade pura, sem banco. Os dois se
complementam: la a algebra da composicao, aqui o caminho que vai a camada e volta — inclusive o caso
que so aparece com banco, o de camada sem feicao na area, que tem de AVISAR em vez de vetar zero em
silencio.
