...
def test_getfeatureinfo_devolve_o_mesmo_valor_do_endpoint_ponto(token_wms, raster_demo):
    ...
    r = _getmap(c, tok, item, REQUEST="GetFeatureInfo", QUERY_LAYERS=item, I="128", J="128",
...
def test_getmap_aceita_epsg_4674_sirgas2000(token_wms, raster_demo):
    c, tok, item = _cliente(), token_wms["token"], raster_demo["item_id"]
    ...
    assert r.status_code == 200, (
        f"EPSG:4674 (SIRGAS2000) deveria ser um CRS suportado pelo GetMap; devolveu "
