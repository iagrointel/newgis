...
def test_vocabulario_python_igual_ao_banco(conexao_plat_app):
    ...
    # 46 + jobs.ver (015) + conteudo.exportar (L0-04-h-exportar) + rede.administrar (L4-03-a) +
    # rede.medir (L4-13-integracao-telemetria)
    assert set(banco) == set(priv.NOMES) and len(banco) == 50
