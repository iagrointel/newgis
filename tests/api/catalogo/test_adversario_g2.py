...
def test_g2_8_funcoes_do_plat_sem_execute_para_public(conexao_plat_app, env):
    """ACHADO G2-8: funções do schema plat sem REVOKE de PUBLIC (proacl nulo ou com '='). Eram 13 no schema de
    produção e 9 no schema da trilha, porque as migrações novas (030 conexão, 046 uploads, 047 convites) não
    repetiram o padrão de REVOKE da 011. O achado foi CORRIGIDO em master; o teste deixou de ser xfail e passou
    a guardar a correção — função nova sem REVOKE de PUBLIC volta a reprovar aqui."""
