...
def _nomes_proibidos() -> list[str]:
    """Nomes que nunca podem aparecer em arquivo de demonstração (cláusula 3). Lido de
    `tests/nomes_proibidos.regex` — a MESMA lista que a fila de junção usa para reprovar nome de
