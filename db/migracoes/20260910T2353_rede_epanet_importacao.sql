-- 20260910T2353_rede_epanet_importacao: importação/exportação EPANET .inp da rede de água (item
...
-- 2.089.315 bytes, a rede de água real usada nos testes) até o job ler e apagar (`arquivo_bytes = NULL` depois de processar,
