-- Documento de estilo (item L2-02-a-modelo-estilo; ADR 20260907-modelo-de-estilo; C2 do L2_CONCEITO): o tipo
-- `estilo` deixa de ter `corpo` livre e passa a carregar o JSON Schema publicado em docs/esquemas/estilo-v1.json
-- (gerado deste esquema por docs/gerar_esquemas.py). Continua esquema_versao = 1 (mesmo raciocinio da migracao do
-- tipo mapa: nao ha estilo gravado ainda por nenhum construtor, entao o aperto de validacao nao migra conteudo).
-- Idempotente.
