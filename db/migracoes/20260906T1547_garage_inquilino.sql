-- 042_garage_inquilino: balde por inquilino no Garage com cota em BYTES e em OBJETOS, endpoint web ligável e
-- registro sem segredo (item L1-01-d-garage-por-inquilino; ADR 0016, que estende o ADR 0006). Estende
