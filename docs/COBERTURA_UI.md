...
| medida | valor |
|---|---|
| rotas (método × caminho) | 913 |
| coberto | 348 |
| sem controle | 243 |
| sem tela | 167 |
| externo | 37 |
| externo sem exposição | 2 |
| sem tela por desenho | 116 |
| cobertas sem estado de erro perto da chamada | 13 |
| lacunas de ESCRITA (linha de base do teste) | 184 |
| URLs chamadas pela tela que não existem na API | 38 |
...
| GET | `/api/acervo/camadas` | acervo | `/acervo`, `/admin/acervo`, `/amc/motor`, `/mapa` | `web/js/acervo/acervo.js:99`<br>`web/js/amc/motor_pagina.js:484`<br>`web/js/auth/acervo.js:104`<br>`web/js/mapa/mapa.js:65` | **coberto** | com erro |
...
| GET | `/api/acervo/{fonte_id}` | acervo | `/acervo`, `/admin/acervo`, `/amc/motor`, `/mapa` | `web/js/acervo/acervo.js:99`<br>`web/js/amc/motor_pagina.js:484`<br>`web/js/auth/acervo.js:104`<br>`web/js/mapa/mapa.js:65` | **coberto** | com erro |
...
| GET | `/api/amc/execucoes/{execucao_id}/unidades/{unidade_id}/explicacao` | amc | `/amc/explicacao/{execucao_id}/{unidade_id}` | `web/js/amc/explicacao_pagina.js:87` | **coberto** | com erro |
...
| GET | `/api/camadas/{id}/campos` | formulario | `/camadas/{id}/formulario`, `/construtor-camada`, `/vista-de-camada` | `web/js/catalogo/camada_esquema.js:186`<br>`web/js/catalogo/vista_camada.js:45`<br>`web/js/formulario/construtor.js:40` | **coberto** | com erro |
...
| GET | `/api/camadas/{id}/feicoes` | regras | `/camadas/{id}/dominios` | `web/js/dominios/tela.js:173` | **coberto** | com erro |
| GET | `/api/camadas/{id}/feicoes/{fid}/popup` | mapa-popup | `/sig` | `web/js/mapa/atributos.js:123` | **coberto** | com erro |
...
| GET | `/api/camadas/{id}/formulario/versoes` | formulario | `/camadas/{id}/formulario` | `web/js/formulario/construtor.js:44` | **coberto** | com erro |
| POST | `/api/camadas/{id}/formulario/versoes` | formulario | `/camadas/{id}/formulario` | `web/js/formulario/construtor.js:170` | **coberto** | com erro |
| GET | `/api/camadas/{id}/formulario/versoes/{versao}` | formulario | `/camadas/{id}/formulario` | `web/js/formulario/construtor.js:51` | **coberto** | com erro |
| POST | `/api/camadas/{id}/formulario/versoes/{versao}/publicar` | formulario | `/camadas/{id}/formulario` | `web/js/formulario/construtor.js:180` | **coberto** | com erro |
...
| GET | `/api/camadas/{item_id}/campos` | camada-esquema | `/camadas/{id}/formulario`, `/construtor-camada`, `/vista-de-camada` | `web/js/catalogo/camada_esquema.js:186`<br>`web/js/catalogo/vista_camada.js:45`<br>`web/js/formulario/construtor.js:40` | **coberto** | com erro |
...
| GET | `/api/camadas/{item_id}/feicoes` | feicoes | `/camadas/{id}/dominios` | `web/js/dominios/tela.js:173` | **coberto** | com erro |
...
| GET | `/api/categorias` | categorias | `/admin/categorias`, `/colecao`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/paineis/{id}` | `web/js/catalogo/api.js:137`<br>`web/js/catalogo/categorias_admin.js:56` | **coberto** | com erro |
...
| GET | `/api/ferramentas` | ferramentas | `/analise`, `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/analise/analise.js:138`<br>`web/js/jobs/api.js:52` | **coberto** | com erro |
...
| GET | `/api/geocodificar` | geocodificador | `/sig` | `web/js/mapa/busca.js:86`<br>`web/js/sig/sig.js:274` | **coberto** | com erro |
...
| GET | `/api/imagens/{item_id}` | imagens | `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/uploads` | `web/js/catalogo/tipos/raster.js:37`<br>`web/js/uploads/enviar.js:60` | **coberto** | com erro |
...
| GET | `/api/itens` | catalogo | `/amc/motor`, `/analise`, `/aplicativo`, `/colecao`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/importacoes`, `/modelos`, `/paineis/{id}`, `/vista-de-camada` | `web/js/amc/motor_pagina.js:483`<br>`web/js/analise/analise.js:139`<br>`web/js/analise/analise.js:140`<br>`web/js/catalogo/api.js:75`<br>`web/js/catalogo/modelos.js:88`<br>`web/js/catalogo/vista_camada.js:33`<br>`web/js/ingestao/importacoes.js:188`<br>`web/js/widgets/base.js:166` | **coberto** | com erro |
...
| GET | `/api/mapas` | mapa | `/sig` | `web/js/sig/sig.js:630`<br>`web/js/sig/sig.js:708` | **coberto** | com erro |
| POST | `/api/mapas` | mapa | `/sig` | `web/js/sig/sig.js:673` | **coberto** | com erro |
...
| PUT | `/api/mapas/{id}` | mapa | `/sig` | `web/js/mapa/documento.js:29`<br>`web/js/mapa/documento.js:42`<br>`web/js/sig/sig.js:699` | **coberto** | com erro |
...
| GET | `/api/modelos` | modelos3d | `/modelos` | `web/js/catalogo/modelos.js:57` | **coberto** | com erro |
| POST | `/api/modelos` | modelos3d | — | — | **sem controle** | não se aplica |
| GET | `/api/modelos/{id}` | modelos3d | `/cena` | `web/js/cena/modelospainel.js:29`<br>`web/js/cena/modelospainel.js:4` | **coberto** | com erro |
| DELETE | `/api/modelos/{id}` | modelos3d | `/modelos` | `web/js/catalogo/modelos.js:72` | **coberto** | com erro |
| GET | `/api/modelos/{id}/3dtiles/{caminho}` | modelos3d | `/cena` | `web/js/cena/modelos3d.js:229` | **coberto** | sem estado de erro |
| GET | `/api/modelos/{id}/elementos` | modelos3d | — | — | **sem controle** | não se aplica |
| GET | `/api/modelos/{id}/elementos/{guid}` | modelos3d | `/cena` | `web/js/cena/modelospainel.js:7`<br>`web/js/cena/modelospainel.js:86` | **coberto** | com erro |
| GET | `/api/modelos/{id}/glb` | modelos3d | `/cena` | `web/js/cena/modelos3d.js:228` | **coberto** | sem estado de erro |
...
| GET | `/api/rede/{rede_id}/feicoes/linhas` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| POST | `/api/rede/{rede_id}/feicoes/linhas` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| POST | `/api/rede/{rede_id}/feicoes/linhas/applyEdits` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| GET | `/api/rede/{rede_id}/feicoes/pontos` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| POST | `/api/rede/{rede_id}/feicoes/pontos` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| POST | `/api/rede/{rede_id}/feicoes/pontos/applyEdits` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
...
| GET | `/api/rede/{rede_id}/topologia` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| GET | `/api/rede/{rede_id}/topologia/alcance` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| GET | `/api/rede/{rede_id}/topologia/areas-sujas` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| GET | `/api/rede/{rede_id}/topologia/arestas` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| POST | `/api/rede/{rede_id}/topologia/habilitar` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
| GET | `/api/rede/{rede_id}/topologia/nos` | rede de utilidades — topologia | — | — | **sem tela** | não se aplica |
...
| GET | `/api/sugerir` | geocodificador | `/sig` | `web/js/mapa/busca.js:78`<br>`web/js/sig/sig.js:274` | **coberto** | com erro |
...
| GET | `/api/uploads/tipos` | uploads | `/sig`, `/uploads` | `web/js/sig/sig.js:552`<br>`web/js/uploads/enviar.js:132`<br>`web/js/uploads/enviar.js:55`<br>`web/js/uploads/nucleo.js:52`<br>`web/js/uploads/nucleo.js:58` | **coberto** | com erro |
| GET | `/api/uploads/{id}` | uploads | `/sig`, `/uploads` | `web/js/sig/sig.js:552`<br>`web/js/uploads/enviar.js:132`<br>`web/js/uploads/enviar.js:55`<br>`web/js/uploads/nucleo.js:52`<br>`web/js/uploads/nucleo.js:58` | **coberto** | com erro |
...
| GET | `/rest/services/{item_id}/FeatureServer/replicas` | replicas-esri | — | `protocolo FeatureServer da Esri (query/applyEdits/addFeatures/anexos/replica) consumido DIRETO por ArcGIS Pro/Field Maps/AGOL depois que o usuário cola a URL do serviço (mostrada na ficha da camada); não há operação individual para virar botão nosso` | **sem tela por desenho** | não se aplica |
...
| GET | `/rest/services/{item_id}/FeatureServer/{camada_id}` | consulta-esri | — | `protocolo FeatureServer da Esri (query/applyEdits/addFeatures/anexos/replica) consumido DIRETO por ArcGIS Pro/Field Maps/AGOL depois que o usuário cola a URL do serviço (mostrada na ficha da camada); não há operação individual para virar botão nosso` | **sem tela por desenho** | não se aplica |
...
| GET | `/rest/services/{item_id}/FeatureServer/{camada_id}/query` | consulta-esri | `/sig` | `web/js/mapa/tabela_atributos.js:26`<br>`web/js/sig/comparar.js:279`<br>`web/js/sig/comparar.js:322` | **coberto** | com erro |
...
| GET | `/rest/services/{item_id}/FeatureServer/{camada}` | featureserver | — | `protocolo FeatureServer da Esri (query/applyEdits/addFeatures/anexos/replica) consumido DIRETO por ArcGIS Pro/Field Maps/AGOL depois que o usuário cola a URL do serviço (mostrada na ficha da camada); não há operação individual para virar botão nosso` | **sem tela por desenho** | não se aplica |
...
- **modelos3d**: POST `/api/modelos` (sem controle)
...
- **rede de utilidades — topologia**: POST `/api/rede/{rede_id}/feicoes/linhas` (sem tela); POST `/api/rede/{rede_id}/feicoes/linhas/applyEdits` (sem tela); POST `/api/rede/{rede_id}/feicoes/pontos` (sem tela); POST `/api/rede/{rede_id}/feicoes/pontos/applyEdits` (sem tela); POST `/api/rede/{rede_id}/topologia/habilitar` (sem tela)
...
- `web/js/amc/motor_pagina.js:430 POST /api/amc/transformacoes/previsao`
- `web/js/amc/motor_pagina.js:804 GET /api/amc/execucoes/{x}/matriz`
- `web/js/amc/presets.js:131 POST /api/amc/presets/{x}/aplicar`
- `web/js/amc/presets.js:163 GET /api/amc/presets/{x}/exportar`
- `web/js/amc/presets.js:203 POST /api/amc/presets/importar`
- `web/js/amc/presets.js:235 DELETE /api/amc/presets/{x}`
- `web/js/amc/presets.js:265 GET /api/amc/presets`
- `web/js/amc/presets.js:96 PATCH /api/amc/presets/{x}`
- `web/js/amc/presets.js:97 POST /api/amc/presets`
- `web/js/app/fontes.js:6 GET /ogc/collections/{id}/items`
- `web/js/app/fontes.js:75 GET /ogc/collections/{x}/items`
...
- `web/js/mapa/edicao.js:199 GET /api/camadas/{x}/feicoes/{x}`
- `web/js/mapa/edicao.js:266 POST /api/camadas/{x}/feicoes/dividir`
- `web/js/mapa/edicao.js:281 POST /api/camadas/{x}/feicoes/unir`
- `web/js/mapa/edicao.js:439 GET /api/camadas/{x}/feicoes/{x}/historico`
- `web/js/mapa/edicao.js:449 POST /api/camadas/{x}/feicoes/{x}/historico/{x}/restaurar`
- `web/js/mapa/edicao.js:467 GET /api/camadas/{x}/feicoes/{x}/anexos`
- `web/js/mapa/edicao.js:472 GET /api/camadas/{x}/feicoes/{x}/anexos/{x}`
- `web/js/mapa/edicao.js:477 GET /api/camadas/{x}/feicoes/{x}/anexos/{x}`
- `web/js/mapa/edicao.js:495 POST /api/camadas/{x}/feicoes/{x}/anexos`
- `web/js/mapa/edicao.js:659 POST /api/camadas/{x}/lote`
- `web/js/mapa/edicao.js:668 POST /api/camadas/{x}/lote`
- `web/js/mapa/estilo_editor.js:140 GET /api/camadas/{x}/classes`
...
- `web/js/mapa/tabela_atributos.js:51 GET /api/rede/{x}/feicoes/{x}.geojson`
- `web/js/portal/portal.js:254 GET /api/openapi.json`
- `web/js/rede/medicao_ficha.js:150 GET /api/rede/{x}/feicoes/pontos.geojson`
- `web/js/sig/sig.js:466 GET /api/rede/{x}/feicoes/linhas.geojson`
- `web/js/sig/sig.js:467 GET /api/rede/{x}/feicoes/pontos.geojson`
...
| L0-06-e-status | entregue | `/api/status` | rota coberta |
| L0-07-f-console-plataforma | entregue | `/api/plataforma` | rota coberta |
| L0-07-f-console-plataforma | entregue | `/p` | página inexistente |
| L0-08-a-oidc | entregue | `/api/sso` | rota coberta |
| L0-08-b-saml | entregue | `/api/sso/saml/metadata` | rota sem tela |
| L0-09-c-xml-iso-validacao | entregue | `/api/itens/{id}/metadado` | rota coberta |
| L1-02-e-cog-direto-por-https-e-endpoint-s3-para-o-pro | entregue | `/c` | página inexistente |
| L1-07-mosaico-por-colecao-e-pegadas | entregue | `/p` | página inexistente |
...
| L2-03-a-api-edicao-transacional | entregue | `/api/camadas/{id}/edicoes` | rota coberta |
| L2-04-d-featureserver-edicao-anexos | entregue | `/uploads/upload` | página existe |
| L2-04-g-ogc-api-features-crs-cql2 | entregue | `/api` | página inexistente |
| L2-06-d-atualizacao-viva-sse | entregue | `/api/eventos` | rota coberta |
| L2-10-b-relacionamentos | entregue | `/api/camadas/{id}/relacionados/{rel}` | rota sem tela |
| L2-11-b-geocodificador-brasil | entregue | `/api/geocodificar` | rota coberta |
| L2-11-c-rota-matriz-isocrona | entregue | `/api/rota` | rota sem tela |
| L2-17-crs-transformacoes | entregue | `/api/crs/{codigo}` | rota coberta |
| L4-02-a-conectado-e-subrede | entregue | `/api/v1/rede/{id}/tracar` | rota sem tela |
| L4-02-e-configuracoes-de-tracado | entregue | `/api/v1/rede/{id}/config_tracado` | rota sem tela |
| L4-04-a-controladores-e-tiers | entregue | `/c` | página inexistente |
...
| L5-14-publicacao-links-embed | entregue | `/p` | página inexistente |
| L2-01-a-basemap-local-pmtiles | entregue | `/mapa` | página existe |
| UX-01-sistema-de-design | entregue | `/estilo-guia` | página existe |
| UX-02-telas-entrada-conta-convite | entregue | `/aceitar-convite` | página existe |
| UX-02-telas-entrada-conta-convite | entregue | `/conta` | página existe |
| UX-02-telas-entrada-conta-convite | entregue | `/entrar` | página existe |
| UX-02-telas-entrada-conta-convite | entregue | `/redefinir-senha` | página existe |
| UX-03-tela-conteudo-item-lixeira | entregue | `/conteudo` | página existe |
| UX-03-tela-conteudo-item-lixeira | entregue | `/conteudo/item` | página existe |
| UX-03-tela-conteudo-item-lixeira | entregue | `/conteudo/lixeira` | página existe |
| UX-04-tela-mapa-polimento | entregue | `/mapa` | página existe |
| UX-05-telas-conexoes-uploads-tarefas-compartilhado | entregue | `/c` | página inexistente |
| UX-05-telas-conexoes-uploads-tarefas-compartilhado | entregue | `/conexoes` | página existe |
| UX-05-telas-conexoes-uploads-tarefas-compartilhado | entregue | `/tarefas` | página existe |
| UX-05-telas-conexoes-uploads-tarefas-compartilhado | entregue | `/uploads` | página existe |
| UX-06-tela-administracao-inquilino | entregue | `/api/convites` | rota coberta |
| UX-06-tela-administracao-inquilino | entregue | `/api/cotas` | rota sem tela |
| UX-06-tela-administracao-inquilino | entregue | `/api/grupos` | rota coberta |
| UX-06-tela-administracao-inquilino | entregue | `/api/org` | rota coberta |
| UX-06-tela-administracao-inquilino | entregue | `/api/sso` | rota coberta |
| UX-09-telas-ferramentas-e-tarefas | entregue | `/tarefas` | página existe |
| UX-10-acervo-sem-tela | entregue | `/api/acervo/{fonte_id}/adicionar` | rota coberta |
| UX-11-arquivos-sem-controle | entregue | `/api/arquivos` | rota coberta |
| UX-11-arquivos-sem-controle | entregue | `/api/arquivos/{sha256}` | rota coberta |
| UX-12-categorias-sem-controle | entregue | `/api/categorias` | rota coberta |
| UX-12-categorias-sem-controle | entregue | `/api/categorias/importar` | rota coberta |
| UX-13-conexoes-sem-controle | entregue | `/api/conexoes` | rota coberta |
| UX-13-conexoes-sem-controle | entregue | `/api/conexoes/{id}` | rota coberta |
| UX-14-geocodificador-sem-tela | entregue | `/api/geocodificar` | rota coberta |
| UX-14-geocodificador-sem-tela | entregue | `/api/reverso` | rota coberta |
| UX-16-ingestao-sem-tela | entregue | `/api/importacoes` | rota coberta |
| UX-16-ingestao-sem-tela | entregue | `/api/importacoes/{id}` | rota coberta |
| UX-16-ingestao-sem-tela | entregue | `/api/importacoes/{id}/confirmar` | rota coberta |
| UX-17-login-sem-controle | entregue | `/api/login/ldap` | rota coberta |
| UX-17-login-sem-controle | entregue | `/api/org/ldap` | rota coberta |
| UX-17-login-sem-controle | entregue | `/api/org/ldap/importar` | rota coberta |
| UX-18-plataforma-sem-tela | entregue | `/api/plataforma/inquilinos` | rota coberta |
| UX-18-plataforma-sem-tela | entregue | `/api/plataforma/inquilinos/{id}` | rota coberta |
| UX-18-plataforma-sem-tela | entregue | `/api/plataforma/inquilinos/{id}/reativar` | rota coberta |
| UX-18-plataforma-sem-tela | entregue | `/api/plataforma/inquilinos/{id}/suspender` | rota coberta |
| UX-19-rede-sem-tela | entregue | `/api/isocrona` | rota sem tela |
| UX-19-rede-sem-tela | entregue | `/api/matriz` | rota sem tela |
| UX-19-rede-sem-tela | entregue | `/api/rota` | rota sem tela |
| UX-20-usuarios-sem-controle | entregue | `/api/papeis/{id}` | rota coberta |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/conjuntos` | rota sem tela |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/conjuntos/{id}` | rota sem tela |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/conjuntos/{id}/macro` | rota sem tela |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/execucoes/{id}/micro` | rota sem tela |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/fatores` | rota sem tela |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/fatores/{id}` | rota sem tela |
| UX-21-multiescala-sem-tela | entregue | `/api/multiescala/fatores/{id}/amostras` | rota sem tela |
| UX-23-mapa-sem-controle | entregue | `/api/anotacoes/{id}` | rota sem tela |
| UX-23-mapa-sem-controle | entregue | `/api/mapa/camadas/{id}/filtrar` | rota sem tela |
| UX-23-mapa-sem-controle | entregue | `/api/mapa/camadas/{id}/selecionar` | rota sem tela |
| UX-23-mapa-sem-controle | entregue | `/api/mapa/pacotes/importar` | rota sem tela |
| UX-23-mapa-sem-controle | entregue | `/api/mapa/selecao-espacial` | rota sem tela |

Itens com efeito visível que não citam página nem rota no texto (163; a cobertura deles é conferida pelo e2e do item, não por este cruzamento): L0-02-b-politica-senha-bloqueio, L0-02-c-2fa-totp, L0-02-d-token-servico, L0-02-f-tela-usuarios, L0-02-tenant-auth, L0-03-b-pastas-tags-categorias-classificacao, L0-03-catalogo, L0-03-d-grupos, L0-03-g-detalhe-item-miniatura, L0-04-d-formatos-base, L0-04-e-formatos-cad, L0-04-h-exportar, L0-04-i-fonte-registrada, L0-04-ingest-vetor, L0-05-d-periodicos, L0-05-e-justica-entre-inquilinos, L0-05-jobs, L0-06-backup-status, L0-06-c-restore-drill, L0-06-d-exportar-inquilino, L0-07-a-configuracoes-org, L0-07-b-papeis-privilegios, L0-07-c-cotas-uso, L0-07-d-smtp-convites, L0-07-e-relatorios, L0-08-c-govbr, L0-08-d-ldap, L0-08-e-mapeamento-provisionamento, L0-09-a-procedencia, L0-09-b-editor-iso-mgb, L0-10-eventos-historico, L0-11-arquivos-objetos, L0-12-contrato-api-e-limites, L0-13-dado-demonstracao, L0-14-cli-admin, L1-01-b-validacao-e-isolamento-da-entrada, L1-01-d-garage-por-inquilino, L1-01-f-formatos-de-entrada, L1-01-i-ciclo-de-vida-exclusao-e-coleta-de-lixo, L1-01-ingest-raster, L1-01-j-proveniencia-da-imagem-lastro, L1-02-b-token-de-servico-com-escopo-por-lista, L1-02-d-cache-nginx-cdn-e-bancada-de-carga, L1-02-f-predefinicoes-de-renderizacao-e-legenda, L2-01-b-martin-tiles-vetoriais, L2-01-c-lista-camadas-legenda, L2-01-e-mapas-base, L2-01-f-navegacao-medicao-coordenadas, L2-01-g-tabela-atributos, L2-01-h-selecao-filtros, L2-01-i-graficos-de-camada, L2-01-j-comparacao-cortina-tempo, L2-01-mapa-web, L2-02-a-modelo-estilo, L2-02-c-editor-simbologia-vetor, L2-02-d-rotulos, L2-02-e-simbolos-sprites-glifos, L2-03-b-ferramentas-geometria, L2-03-c-formulario-atributos-runtime, L2-03-f-edicao-em-lote-calculo-campo, L2-04-b-featureserver-catalogo-metadados, L2-04-c-featureserver-query, L2-04-f-mapserver-identify-legend-geometryserver, L2-04-h-wfs-2-gml, L2-04-i-wms-wmts-sld, L2-04-j-conformidade-clientes-e-paridade, L2-04-servicos-esri-ogc, L2-05-a-catalogo-ferramentas-gpserver, L2-05-b-vetor-basico, L2-05-c-sobreposicao-agregacao, L2-05-d-grades-densidade-padroes-interpolacao, L2-05-e-raster-basico, L2-05-f-rede-isocrona-rota-ferramentas, L2-06-a-modelo-painel-fontes, L2-06-b-elementos-basicos, L2-06-c-acoes-seletores-filtros-cruzados, L2-07-b-formulario-de-coleta-xlsform, L2-07-campo, L2-07-e-odk-central-ponte, L2-08-a-leitor-portal-inventario, L2-08-b-clonar-camadas-hospedadas, L2-08-migracao-agol, L2-09-3d, L2-09-a-terreno-terrain-rgb-relevo, L2-09-b-cena-extrusao-slides, L2-09-c-modelos-gltf-ifc-3dtiles, L2-09-d-analise-3d-visibilidade, L2-10-c-linguagem-expressao, L2-10-d-regras-de-atributo, L2-11-a-geocodificacao-csv, L2-12-a-motor-render-servidor, L2-13-a-versoes-ramo-reconciliar, L2-16-a-sdk-python-geo, L2-16-c-script-vira-ferramenta, L3-01-b-unidades, L3-01-e-combinacao, L3-01-f-explicacao, L3-01-g-tela-motor, L3-01-h-presets, L3-01-i-exportacao-metodo, L3-05-localizar-regioes, L3-06-criterios-de-feicao, L3-08-pareto, L3-10-corredor-custo-minimo, L3-14-cobertura-dado-ausente, L3-16-desempenho-escala, L4-02-b-montante-jusante, L4-02-c-isolamento, L4-02-d-lacos-e-caminho-curto, L4-02-f-resultados-e-exportacao, L4-04-b-atualizar-e-exportar-subrede, L4-04-c-sumarios-por-subrede, L4-04-d-diagrama-esquematico, L4-15-serie-temporal-da-rede, L4-parcelas-01-modelo-de-parcelas, L4-parcelas-02-fluxos-cogo, L5-01-a-layout-paginas, L5-01-c-widgets-dado, L5-01-d-widgets-pagina-menu, L5-01-e-acoes-configuraveis, L5-03-form-builder, L5-04-a-blocos-de-conteudo, L5-04-c-temas-capa-colecao, L5-06-motor-widgets, L5-07-fontes-vistas-mensagens, L5-08-editor-arrasto, L5-09-desfazer-refazer-rascunho, L5-10-temas-marca, L5-11-expressoes-no-navegador, L5-12-acessibilidade-i18n-construtores, L5-13-edicao-concorrente, L5-15-vista-movel-responsivo, L5-20-sites-paginas-publicas, L5-31-construtor-de-camada-esquema, L5-32-vistas-de-camada, L5-36-widgets-personalizados-sdk, L5-37-pacotes-modelos-entre-inquilinos, L6-01-b-view-so-leitura, L6-01-d-ficha-fonte, L6-01-g-licenca-curada, L6-02-c-wfs-ogcapi, L6-02-conectores-vivos, L6-02-j-bancos-externos, L6-02-k-agendamento, L6-02-l-saude, L6-02-m-catalogo-endpoints-brasil, L6-05-proveniencia-camada-externa, L7-03-e-cabecalhos-csp-tls, L7-04-a-manual-capturas-geradas, L7-04-d-videos-por-tarefa, L7-06-b-alertas, L7-06-c-logs-consulta-req-id, L7-06-d-paineis, L7-08-c-sdk-js, L7-11-b-appliance-sem-internet, L7-11-c-telemetria-opcional, L7-13-a-chamados, L7-20-trilha-auditoria, L7-29-roteiro-demonstracao, UX-00-mapa-de-cobertura-da-interface, UX-07-telas-do-construtor-e-aplicativo, UX-08-telas-rede-de-utilidades-e-motor, UX-15-geocodificador-esri-sem-controle
