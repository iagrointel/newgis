...
| cobertas sem estado de erro perto da chamada | 3 |
| lacunas de ESCRITA (linha de base do teste) | 11 |
...
| GET | `/api/agendas` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:50` | **coberto** | com erro |
| POST | `/api/agendas` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:52` | **coberto** | com erro |
| GET | `/api/agendas/{agenda_id}` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:51` | **coberto** | com erro |
| PUT | `/api/agendas/{agenda_id}` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:53` | **coberto** | com erro |
| DELETE | `/api/agendas/{agenda_id}` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:54` | **coberto** | com erro |
| POST | `/api/agendas/{agenda_id}/pausar` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:55` | **coberto** | com erro |
| POST | `/api/agendas/{agenda_id}/retomar` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:56` | **coberto** | com erro |
| POST | `/api/agendas/{agenda_id}/rodar-agora` | agendas | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:57` | **coberto** | com erro |
...
| GET | `/api/arquivos` | arquivos | `/admin/organizacao` | `web/js/auth/organizacao.js:415` | **coberto** | com erro |
| POST | `/api/arquivos` | arquivos | `/admin/organizacao` | `web/js/auth/organizacao.js:487` | **coberto** | com erro |
| GET | `/api/arquivos/_varredura` | arquivos | `/admin/organizacao` | `web/js/auth/organizacao.js:185`<br>`web/js/auth/organizacao.js:431`<br>`web/js/auth/organizacao.js:443` | **coberto** | com erro |
| GET | `/api/arquivos/{sha256}` | arquivos | `/admin/organizacao` | `web/js/auth/organizacao.js:185`<br>`web/js/auth/organizacao.js:431`<br>`web/js/auth/organizacao.js:443` | **coberto** | com erro |
| DELETE | `/api/arquivos/{sha256}` | arquivos | `/admin/organizacao` | `web/js/auth/organizacao.js:455` | **coberto** | com erro |
...
| GET | `/api/eu` | eu | `/`, `/admin`, `/admin/acervo`, `/admin/grupos`, `/admin/log`, `/admin/organizacao`, `/admin/papeis`, `/admin/tokens`, `/admin/usuarios`, `/c/{token}`, `/conexoes`, `/construtor`, `/conta`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/entrar`, `/estilo-guia`, `/executar`, `/ferramentas`, `/mapa`, `/plataforma`, `/tarefas`, `/tarefas/{job_id}`, `/uploads` | `web/app.js:36`<br>`web/js/auth/conta.js:90`<br>`web/js/auth/sessao.js:59`<br>`web/js/conexoes/conexoes.js:451`<br>`web/js/jobs/tarefas.js:54` | **coberto** | com erro |
...
| GET | `/api/eventos` | log | `/admin`, `/admin/acervo`, `/admin/grupos`, `/admin/log`, `/admin/organizacao`, `/admin/papeis`, `/admin/tokens`, `/admin/usuarios`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/plataforma` | `web/js/auth/admin.js:125`<br>`web/js/auth/comum.js:67`<br>`web/js/auth/log.js:165` | **coberto** | com erro |
| GET | `/api/exportacoes` | exportacao | `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}` | `web/js/catalogo/api.js:137` | **coberto** | com erro |
| POST | `/api/exportacoes` | exportacao | `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/mapa` | `web/js/catalogo/api.js:135`<br>`web/js/mapa/exportar.js:259` | **coberto** | com erro |
| GET | `/api/exportacoes/formatos` | exportacao | `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/mapa` | `web/js/catalogo/api.js:134`<br>`web/js/catalogo/api.js:136`<br>`web/js/mapa/exportar.js:29`<br>`web/js/mapa/exportar.js:58` | **coberto** | com erro |
| GET | `/api/exportacoes/{exportacao_id}` | exportacao | `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/mapa` | `web/js/catalogo/api.js:134`<br>`web/js/catalogo/api.js:136`<br>`web/js/mapa/exportar.js:29`<br>`web/js/mapa/exportar.js:58` | **coberto** | com erro |
...
| GET | `/api/grupos` | grupos | `/admin`, `/admin/grupos`, `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/mapa` | `web/js/auth/admin.js:72`<br>`web/js/auth/grupos.js:108`<br>`web/js/catalogo/api.js:159`<br>`web/js/mapa/anotacoes.js:41` | **coberto** | com erro |
...
| POST | `/api/itens` | catalogo | `/c/{token}`, `/construtor`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/mapa` | `web/js/catalogo/api.js:94`<br>`web/js/editor/tela.js:91`<br>`web/js/mapa/mapa.js:352`<br>`web/js/mapa/selecao.js:369` | **coberto** | com erro |
| GET | `/api/itens/facetas` | catalogo | `/aplicativo`, `/c/{token}`, `/construtor`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/executar`, `/mapa` | `web/js/catalogo/api.js:79`<br>`web/js/catalogo/api.js:91`<br>`web/js/catalogo/api.js:93`<br>`web/js/editor/tela.js:116`<br>`web/js/executor/executar_tela.js:33`<br>`web/js/mapa/mapa.js:394`<br>`web/js/widgets/aplicativo.js:114` | **coberto** | com erro |
...
| PUT | `/api/itens/{id}` | catalogo | `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/mapa` | `web/js/catalogo/api.js:95`<br>`web/js/mapa/mapa.js:351` | **coberto** | com erro |
...
| POST | `/api/jobs` | jobs | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:40` | **coberto** | com erro |
| GET | `/api/jobs/resumo` | jobs | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:39`<br>`web/js/jobs/api.js:45` | **coberto** | com erro |
| GET | `/api/jobs/tipos` | jobs | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:39`<br>`web/js/jobs/api.js:46` | **coberto** | com erro |
| GET | `/api/jobs/{job_id}` | jobs | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:39`<br>`web/js/jobs/api.js:45`<br>`web/js/jobs/api.js:46` | **coberto** | com erro |
| POST | `/api/jobs/{job_id}/cancelar` | jobs | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/api.js:41` | **coberto** | com erro |
| GET | `/api/jobs/{job_id}/eventos` | jobs | `/ferramentas`, `/tarefas`, `/tarefas/{job_id}` | `web/js/jobs/eventos.js:41` | **coberto** | sem estado de erro |
...
| POST | `/api/login` | login | `/entrar` | `web/js/auth/login.js:192` | **coberto** | com erro |
| POST | `/api/login/2fa` | login | `/entrar` | `web/js/auth/login.js:224` | **coberto** | com erro |
| POST | `/api/login/ldap` | login | `/entrar` | `web/js/auth/login.js:192` | **coberto** | com erro |
| GET | `/api/login/provedores` | login | `/entrar` | `web/js/auth/login.js:90` | **coberto** | com erro |
| POST | `/api/logout` | login | `/`, `/admin`, `/admin/acervo`, `/admin/grupos`, `/admin/log`, `/admin/organizacao`, `/admin/papeis`, `/admin/tokens`, `/admin/usuarios`, `/c/{token}`, `/conexoes`, `/construtor`, `/conta`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/entrar`, `/estilo-guia`, `/executar`, `/ferramentas`, `/mapa`, `/plataforma`, `/tarefas`, `/tarefas/{job_id}`, `/uploads` | `web/js/auth/sessao.js:76` | **coberto** | sem estado de erro |
...
| GET | `/api/mapa/camadas/{id}/estilo` | mapa | `/mapa` | `web/js/mapa/exportar.js:225` | **coberto** | com erro |
| GET | `/api/mapa/camadas/{id}/feicoes/{fid}` | mapa | `/mapa` | `web/js/mapa/exportar.js:50` | **coberto** | com erro |
| POST | `/api/mapa/camadas/{id}/filtrar` | mapa | `/mapa` | `web/js/mapa/selecao.js:252` | **coberto** | com erro |
| POST | `/api/mapa/camadas/{id}/selecionar` | mapa | `/mapa` | `web/js/mapa/selecao.js:264` | **coberto** | sem estado de erro |
| GET | `/api/mapa/camadas/{id}/tilejson` | mapa | — | — | **sem controle** | não se aplica |
| GET | `/api/mapa/camadas/{id}/valores` | mapa | `/mapa` | `web/js/mapa/selecao.js:207` | **coberto** | com erro |
| GET | `/api/mapa/fuso` | mapa-popup | `/mapa` | `web/js/mapa/mapa.js:466` | **coberto** | com erro |
| POST | `/api/mapa/pacotes/importar` | mapa | `/mapa` | `web/js/mapa/exportar.js:177` | **coberto** | com erro |
| POST | `/api/mapa/selecao-espacial` | mapa | `/mapa` | `web/js/mapa/selecao.js:276` | **coberto** | com erro |
| POST | `/api/mapa/{mapa_id}/desenho/promover` | mapa | `/mapa` | `web/js/mapa/mapa.js:368` | **coberto** | com erro |
...
| POST | `/api/multiescala/conjuntos/{id}/macro` | multiescala | `/mapa` | `web/js/mapa/motor.js:322` | **coberto** | com erro |
...
| GET | `/api/multiescala/execucoes/{id}/celulas` | multiescala | `/mapa` | `web/js/mapa/motor.js:364` | **coberto** | com erro |
| POST | `/api/multiescala/execucoes/{id}/micro` | multiescala | `/mapa` | `web/js/mapa/motor.js:323` | **coberto** | com erro |
| GET | `/api/multiescala/fatores` | multiescala | `/mapa` | `web/js/mapa/motor.js:209` | **coberto** | com erro |
| POST | `/api/multiescala/fatores` | multiescala | `/mapa` | `web/js/mapa/motor.js:247` | **coberto** | com erro |
| GET | `/api/multiescala/fatores/{id}` | multiescala | — | — | **sem controle** | não se aplica |
| DELETE | `/api/multiescala/fatores/{id}` | multiescala | `/mapa` | `web/js/mapa/motor.js:256` | **coberto** | com erro |
| POST | `/api/multiescala/fatores/{id}/amostras` | multiescala | `/mapa` | `web/js/mapa/motor.js:283` | **coberto** | com erro |
...
| GET | `/api/papeis` | usuarios | `/admin`, `/admin/acervo`, `/admin/grupos`, `/admin/log`, `/admin/organizacao`, `/admin/papeis`, `/admin/tokens`, `/admin/usuarios`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/plataforma` | `web/js/auth/admin.js:75`<br>`web/js/auth/comum.js:25`<br>`web/js/auth/papeis.js:70` | **coberto** | com erro |
...
| GET | `/api/plataforma/inquilinos` | plataforma | `/plataforma` | `web/js/auth/plataforma.js:59` | **coberto** | com erro |
| POST | `/api/plataforma/inquilinos` | plataforma | `/plataforma` | `web/js/auth/plataforma.js:128` | **coberto** | com erro |
| DELETE | `/api/plataforma/inquilinos/{id}` | plataforma | `/plataforma` | `web/js/auth/plataforma.js:84` | **coberto** | com erro |
| POST | `/api/plataforma/inquilinos/{id}/reativar` | plataforma | `/plataforma` | `web/js/auth/plataforma.js:93` | **coberto** | com erro |
| POST | `/api/plataforma/inquilinos/{id}/suspender` | plataforma | `/plataforma` | `web/js/auth/plataforma.js:89` | **coberto** | com erro |
...
| POST | `/api/tokens` | tokens | `/admin/organizacao`, `/admin/tokens`, `/c/{token}`, `/conteudo`, `/conteudo/lixeira`, `/conteudo/{id}`, `/uploads` | `web/js/auth/organizacao.js:482`<br>`web/js/auth/tokens.js:162`<br>`web/js/catalogo/api.js:43`<br>`web/js/uploads/enviar.js:36` | **coberto** | com erro |
| GET | `/api/tokens/{id}` | tokens | `/admin/tokens` | `web/js/auth/tokens.js:199` | **coberto** | com erro |
| DELETE | `/api/tokens/{id}` | tokens | `/admin/organizacao`, `/admin/tokens` | `web/js/auth/organizacao.js:493`<br>`web/js/auth/tokens.js:131` | **coberto** | com erro |
...
| `/plataforma` | plataforma.html | sim | sim | sim | sim | sim |
...
| UX-16-ingestao-sem-tela | parcial | `/api/importacoes` | rota sem tela |
| UX-16-ingestao-sem-tela | parcial | `/api/importacoes/{id}` | rota sem tela |
| UX-16-ingestao-sem-tela | parcial | `/api/importacoes/{id}/confirmar` | rota sem tela |
| UX-19-rede-sem-tela | parcial | `/api/isocrona` | rota coberta |
| UX-19-rede-sem-tela | parcial | `/api/matriz` | rota coberta |
| UX-19-rede-sem-tela | parcial | `/api/rota` | rota coberta |
| UX-20-usuarios-sem-controle | parcial | `/api/papeis/{id}` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/conjuntos` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/conjuntos/{id}` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/conjuntos/{id}/macro` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/execucoes/{id}/micro` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/fatores` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/fatores/{id}` | rota coberta |
| UX-21-multiescala-sem-tela | parcial | `/api/multiescala/fatores/{id}/amostras` | rota coberta |
| UX-23-mapa-sem-controle | parcial | `/api/anotacoes/{id}` | rota coberta |
| UX-23-mapa-sem-controle | parcial | `/api/mapa/camadas/{id}/filtrar` | rota coberta |
| UX-23-mapa-sem-controle | parcial | `/api/mapa/camadas/{id}/selecionar` | rota coberta |
| UX-23-mapa-sem-controle | parcial | `/api/mapa/pacotes/importar` | rota coberta |
| UX-23-mapa-sem-controle | parcial | `/api/mapa/selecao-espacial` | rota coberta |
