...
Gerado de laco/PAINEL.md (seção Fronteira) em 2026-09-10. Não editar entre os marcadores: rode `venv/bin/python docs/gerar_demo.py --preencher` depois de regenerar o painel.
