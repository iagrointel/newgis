...
# Restaurado 16/09/2026: as rotas nasceram no commit d6025bbf4 (08/09) e sumiram de app/amc/rotas.py numa
# fusão — a lógica de app/amc/transformacoes.py (pre_visualizar, curva, transformar) e as constantes de
# limites.AMC_MATRIZ_PAGINA_MAX/AMC_PREVISAO_VALORES_MAX (commit-irmão 43cc9acde) sobreviveram intactas; só o
# arquivo de rotas perdeu o bloco. Achado por tests/api/amc/test_matriz_api.py (as duas rotas devolviam 404).
