...
SQL_BASE = (
    "SELECT r.id, r.nome, r.disciplina, r.descricao, r.tolerancia_m, r.regras_ativas, r.pacote_codigo, "
    "r.pacote_nome, r.pacote_versao, "
...
# Bloco restaurado de 35e67565: a fusão de 17/09 ficou com um rotas.py sem estas 5 rotas (categorias.py e os
# modelos sobreviveram); sem elas, PUT .../tipos/{id}/restricoes e cia respondiam 404.
