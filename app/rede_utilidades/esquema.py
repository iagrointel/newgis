...
# `sem_geometria` vale dos dois lados: é o caso dos OBJETOS não espaciais da utility network (objeto de
# aresta e objeto de junção em tabela não espacial) — o pacote transmissao-matpower liga o ramo (objeto de
# aresta) à barra (objeto de junção) e os dois grupos são sem_geometria. A conferência de papel continua
# recusando ponto como aresta e linha como junção.
GEOMETRIA_JUNCAO = ("ponto", "sem_geometria")
GEOMETRIA_ARESTA = ("linha", "sem_geometria")
