...
from app.ferramentas import grade as _grade  # noqa: F401 — registra as ferramentas de grade e padrão (L2-05-d)
from app.ferramentas import relacao as _relacao  # noqa: F401 — registra as ferramentas de relação (L2-05-c)
