...
class CorredorEntrada(BaseModel):
    ...
    custo_maximo: float = Field(
        10.0, gt=1.0, le=1000.0, allow_inf_nan=False,
    ...
    veto_abaixo_de: float | None = Field(None, ge=0.0, le=100.0, allow_inf_nan=False,
                                         description="nota abaixo da qual a célula é veto")
    ...
    epsilon: float | None = Field(0.05, ge=0.0, le=1.0, allow_inf_nan=False,
