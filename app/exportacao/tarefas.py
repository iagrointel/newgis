...
from app.consulta.cql2_selecao import colunas_da_camada
    ...
    try:
        ...
        if formato.nome == "pacote":
            ...
            if formato.nome == "kmz":
                ...
                # o driver OpenFileGDB recusa criar o diretório se o nome não terminar em ".gdb" ("Extension
                # of the directory should be gdb", medido nesta máquina em 16/09) — "saida_dir" sem extensão
                # falha sempre, driver presente ou não.
