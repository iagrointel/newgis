...
def obter_feicao(cur, camada_id: str, globalid: str) -> dict:
    ...
    formulário: a ficha do MVT nunca é fonte de verdade geométrica (item L2-03-edicao). Também usada por
    `app.replica.servico` (item L2-13-b) para montar o "atual" de um conflito — restaurada junto com a rota
    em 9b347a2c8, perdida na mesma fusão que derrubou app/edicao/rotas.py."""
