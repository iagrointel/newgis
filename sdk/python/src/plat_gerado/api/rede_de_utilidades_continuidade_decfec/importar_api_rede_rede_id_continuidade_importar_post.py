...
from ...models.importar_entrada_continuidade import ImportarEntradaContinuidade
...
def _get_kwargs(
    rede_id: str,
    *,
    body: ImportarEntradaContinuidade,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/rede/{rede_id}/continuidade/importar".format(
