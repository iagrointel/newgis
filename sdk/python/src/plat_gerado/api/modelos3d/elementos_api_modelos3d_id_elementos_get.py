...
def _get_kwargs(
    ...
    *,
    ...
    pavimento: None | str | Unset = UNSET,
    ...
    json_pavimento: None | str | Unset
    if isinstance(pavimento, Unset):
        json_pavimento = UNSET
    else:
        json_pavimento = pavimento
    params["pavimento"] = json_pavimento
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/modelos3d/{id}/elementos".format(
