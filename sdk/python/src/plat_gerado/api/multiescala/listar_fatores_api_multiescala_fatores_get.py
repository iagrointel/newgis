...
from ...models.fator_pagina import FatorPagina
...
) -> FatorPagina | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = FatorPagina.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[FatorPagina | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        FatorPagina | HTTPValidationError
    """
