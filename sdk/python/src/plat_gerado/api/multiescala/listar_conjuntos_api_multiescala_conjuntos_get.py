...
from ...models.conjunto_pagina import ConjuntoPagina
...
) -> ConjuntoPagina | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ConjuntoPagina.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ConjuntoPagina | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ConjuntoPagina | HTTPValidationError
    """
