...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/rede/{rede_id}/promover".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Promover Rede Simples

     Promove a rede simples a rede de utilidades: grava o PACOTE MÍNIMO (o mesmo catálogo que ela já
    usava,
