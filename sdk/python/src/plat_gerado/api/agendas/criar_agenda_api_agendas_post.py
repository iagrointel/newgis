...
from ...models.criar_agenda_api_agendas_post_corpo import CriarAgendaApiAgendasPostCorpo
...
def _get_kwargs(
    *,
    body: CriarAgendaApiAgendasPostCorpo,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Agenda | Erro | None:
    if response.status_code == 201:
        response_201 = Agenda.from_dict(response.json())
