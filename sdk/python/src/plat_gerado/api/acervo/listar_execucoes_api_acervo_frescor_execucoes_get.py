...
from ...models.acervo_execucao_pagina import AcervoExecucaoPagina
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/acervo/frescor/execucoes",
        "params": params,
    }
...
) -> AcervoExecucaoPagina | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = AcervoExecucaoPagina.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AcervoExecucaoPagina | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        AcervoExecucaoPagina | HTTPValidationError
    """
