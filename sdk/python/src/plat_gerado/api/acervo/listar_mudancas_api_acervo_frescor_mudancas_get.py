...
from ...models.acervo_mudanca_pagina import AcervoMudancaPagina
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/acervo/frescor/mudancas",
        "params": params,
    }
...
) -> AcervoMudancaPagina | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = AcervoMudancaPagina.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AcervoMudancaPagina | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        AcervoMudancaPagina | HTTPValidationError
    """
