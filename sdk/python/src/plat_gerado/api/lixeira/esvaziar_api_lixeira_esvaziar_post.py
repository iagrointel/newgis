...
from ...models.esvaziar_entrada import EsvaziarEntrada
...
def _get_kwargs(
    *,
    body: EsvaziarEntrada | None | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/lixeira/esvaziar",
    }

    if isinstance(body, EsvaziarEntrada):
...
def sync_detailed(
    *,
    ...
    Args:
        body (EsvaziarEntrada | None | Unset):
