...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/svc/{token}/raster/{item}/{z}/{x}/{y}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        expressao (None | str | Unset): expressão sobre bandas, ex.: (b4-b3)/(b4+b3) para NDVI
        bandas (None | str | Unset): bandas na ordem de saída, ex.: 3,2,1
        faixa (None | str | Unset): faixa de valores min,max por banda
