...
from ...models.preset_pagina import PresetPagina
...
) -> HTTPValidationError | PresetPagina | None:
    if response.status_code == 200:
        response_200 = PresetPagina.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PresetPagina]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PresetPagina
    """
