...
from ...models.endpoint_publico_pagina import EndpointPublicoPagina
...
) -> EndpointPublicoPagina | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = EndpointPublicoPagina.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EndpointPublicoPagina | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EndpointPublicoPagina | HTTPValidationError
    """
