...
from ..models.apply_lsa_entrada_analysistype import ApplyLsaEntradaAnalysistype
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.apply_lsa_entrada_parcel_features_item import ApplyLsaEntradaParcelFeaturesItem


T = TypeVar("T", bound="ApplyLsaEntrada")


@_attrs_define
class ApplyLsaEntrada:
    """
    Attributes:
        parcel_features (list[ApplyLsaEntradaParcelFeaturesItem]):
        gdb_version (None | str | Unset):
        session_id (None | str | Unset):
        analysis_type (ApplyLsaEntradaAnalysistype | Unset):  Default:
            ApplyLsaEntradaAnalysistype.WEIGHTED_LEAST_SQUARES.
        convergence_tolerance (float | Unset):  Default: 0.05.
        sem_linhas (list[str] | None | Unset):
        movement_tolerance (float | Unset):  Default: 0.05.
        update_attributes (bool | Unset):  Default: True.
    """

    parcel_features: list[ApplyLsaEntradaParcelFeaturesItem]
    gdb_version: None | str | Unset = UNSET
    session_id: None | str | Unset = UNSET
    analysis_type: ApplyLsaEntradaAnalysistype | Unset = ApplyLsaEntradaAnalysistype.WEIGHTED_LEAST_SQUARES
    convergence_tolerance: float | Unset = 0.05
    sem_linhas: list[str] | None | Unset = UNSET
    movement_tolerance: float | Unset = 0.05
    update_attributes: bool | Unset = True
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if movement_tolerance is not UNSET:
            field_dict["movementTolerance"] = movement_tolerance
        if update_attributes is not UNSET:
            field_dict["updateAttributes"] = update_attributes

        return field_dict

    @classmethod
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.apply_lsa_entrada_parcel_features_item import ApplyLsaEntradaParcelFeaturesItem  # noqa: PLC0415

        d = dict(src_dict)
        parcel_features = []
        _parcel_features = d.pop("parcelFeatures")
        for parcel_features_item_data in _parcel_features:
            parcel_features_item = ApplyLsaEntradaParcelFeaturesItem.from_dict(parcel_features_item_data)
        ...
        analysis_type: ApplyLsaEntradaAnalysistype | Unset
        if isinstance(_analysis_type, Unset):
            analysis_type = UNSET
        else:
            analysis_type = ApplyLsaEntradaAnalysistype(_analysis_type)
        ...
        movement_tolerance = d.pop("movementTolerance", UNSET)

        update_attributes = d.pop("updateAttributes", UNSET)

        apply_lsa_entrada = cls(
        ...
        apply_lsa_entrada.additional_properties = d
        return apply_lsa_entrada
