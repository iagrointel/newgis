...
if TYPE_CHECKING:
    from ..models.conexao_adicionada_config import ConexaoAdicionadaConfig
    from ..models.dono import Dono


T = TypeVar("T", bound="ConexaoAdicionada")


@_attrs_define
class ConexaoAdicionada:
    """
    Attributes:
        id (str):
        tipo (str):
        ...
        url (str):
        saude (str):
        config (ConexaoAdicionadaConfig):
        tem_credencial (bool):
        dono (Dono):
        criado_em (str):
        atualizado_em (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.conexao_adicionada_config import ConexaoAdicionadaConfig  # noqa: PLC0415
        ...
        config = ConexaoAdicionadaConfig.from_dict(d.pop("config"))
        ...
        conexao_adicionada.additional_properties = d
        return conexao_adicionada
