...
if TYPE_CHECKING:
    from ..models.provedor_saml_entrada_sso_mapa_grupo_perfil import ProvedorSamlEntradaSsoMapaGrupoPerfil


T = TypeVar("T", bound="ProvedorSamlEntradaSso")


@_attrs_define
class ProvedorSamlEntradaSso:
    """
    Attributes:
        idp_entidade (str):
        idp_url_sso (str):
        ...
        mapa_grupo_perfil (ProvedorSamlEntradaSsoMapaGrupoPerfil | Unset):
    """
    ...
    mapa_grupo_perfil: ProvedorSamlEntradaSsoMapaGrupoPerfil | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.provedor_saml_entrada_sso_mapa_grupo_perfil import (
            ProvedorSamlEntradaSsoMapaGrupoPerfil,  # noqa: PLC0415
        )

        d = dict(src_dict)
        idp_entidade = d.pop("idp_entidade")

        idp_url_sso = d.pop("idp_url_sso")

        idp_certificado = d.pop("idp_certificado")
        ...
        if isinstance(_mapa_grupo_perfil, Unset):
            ...
            mapa_grupo_perfil = ProvedorSamlEntradaSsoMapaGrupoPerfil.from_dict(_mapa_grupo_perfil)

        provedor_saml_entrada_sso = cls(
            idp_entidade=idp_entidade,
            idp_url_sso=idp_url_sso,
            idp_certificado=idp_certificado,
        ...
        return provedor_saml_entrada_sso
