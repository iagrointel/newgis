...
if TYPE_CHECKING:
    from ..models.conexao_criada_config import ConexaoCriadaConfig
    from ..models.dono import Dono


T = TypeVar("T", bound="ConexaoCriada")
...
class ConexaoCriada:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.conexao_criada_config import ConexaoCriadaConfig  # noqa: PLC0415
        ...
        config = ConexaoCriadaConfig.from_dict(d.pop("config"))
        ...
        conexao_criada.additional_properties = d
        return conexao_criada
