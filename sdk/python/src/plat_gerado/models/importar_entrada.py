...
if TYPE_CHECKING:
    from ..models.importar_entrada_fields_item import ImportarEntradaFieldsItem
    from ..models.importar_entrada_types_item import ImportarEntradaTypesItem


T = TypeVar("T", bound="ImportarEntrada")


@_attrs_define
class ImportarEntrada:
    ...
    `domains`/`templates`. É o mesmo objeto que a Esri publica em `/FeatureServer/0?f=json`.
        ...
        Attributes:
            fields (list[ImportarEntradaFieldsItem] | Unset):
            types (list[ImportarEntradaTypesItem] | Unset):
            prefixo (None | str | Unset):
            item_id (None | str | Unset):
    """

    fields: list[ImportarEntradaFieldsItem] | Unset = UNSET
    types: list[ImportarEntradaTypesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.importar_entrada_fields_item import ImportarEntradaFieldsItem  # noqa: PLC0415
        from ..models.importar_entrada_types_item import ImportarEntradaTypesItem  # noqa: PLC0415
        ...
        if _fields is not UNSET:
            ...
            for fields_item_data in _fields:
                fields_item = ImportarEntradaFieldsItem.from_dict(fields_item_data)
        ...
        if _types is not UNSET:
            ...
            for types_item_data in _types:
                types_item = ImportarEntradaTypesItem.from_dict(types_item_data)
